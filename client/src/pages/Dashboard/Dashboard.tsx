    ...
    <div className='w-full flex'>
      ...
      <div className='w-full'> 
        ...
        <div className='flex'>
          ...
          <div className='w-full bg-[#011E54]' style={{ height: 'calc(100vh - 75px)' }}>
           {/* Main Content */ }
            <div className="Rectangle9 m-5 mt-12" style={{width: 643, height: 194, background: 'linear-gradient(144deg, #360754 25%, #D92A99 100%)', boxShadow: '10px 10px 25px rgba(0, 0, 0, 0.25)', borderRadius: 30}}>
          ...
          <div className=' bg-[#011E54] w-1/4 ' style={{ height: 'calc(100vh - 75px)' }}>
            {/* other Content */ }
